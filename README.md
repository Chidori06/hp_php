## Harry Potter : les personnages

Utilisation de PHP pour afficher des données d'une API

### Consigne de l'exercice :
### Exercice : Afficher dynamiquement des personnages Harry Potter avec Bootstrap et JSON
...
### Bonus
- Afficher l'image de la maison auquel le personnage appartient (dans la card à au dessus du nom de la maison)
- Afficher en haut à droite de la card, une tête de mort si le personnage est mort
- Changer la bordure de la card en fonction du genre : 
    - Si male = bleu
    - Si female = rouge
    - Si non-renseigné = noir
